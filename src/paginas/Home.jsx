...
function Home () {
  ...
  <p className='welcome'>Bienvenido a su tienda de</p><h1>Promería/ Fontanería</h1>
  </div>
  ...
  <div className='paragraph'>
    ...
    <Link className='link' to="AboutUs">Sepa más sobre nosotros</Link>
  </div>
  ...
  <footer>
    ...
    <p>Todos nuestros productos están abalados por la norma ISO 9001</p><p>La empresa se reserva todos los derechos de este sítio</p>
